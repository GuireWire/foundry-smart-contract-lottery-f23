...
contract HelperConfig is CodeConstants, Script {
        ...
        returns (NetworkConfig memory mainnetNetworkConfig)
    {
        mainnetNetworkConfig = NetworkConfig({
            ...
            callbackGasLimit: 2000000, // 2,000,000 gas
            vrfCoordinatorV2_5: 0x271682DEB8C4E0901D1a1550aD2e64D568E69909,
            link: 0x514910771AF9Ca656af840dff83E8264EcF986CA,
            account: 0xe909C3c8eC96C25Dc663B784040C4Eb99276E801
        });
    }
    ...
    function getOrCreateAnvilEthConfig() public returns (NetworkConfig memory) {
        // Check to see if we set an active network config - //if function below states if address already exists then it won't create a new one again
